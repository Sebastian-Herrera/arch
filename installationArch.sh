...
pacstrap /mnt base base-devel linux linux-firmware intel-ucode man-db man-pages grub networkmanager zsh neovim git xorg-server xorg-xinit mesa mesa-demos pulseaudio
