...
yay -S --noconfirm systemd-numlockontty xdg-user-dirs neofetch zsh-theme-powerlevel10k-git unzip qtile alacritty rofi nautilus noto-fonts-emoji google-chrome visual-studio-code-bin
