...
#pulseaudio
yay -Sy --noconfirm xdg-user-dirs neofetch zsh-theme-powerlevel10k-git noto-fonts-emoji unzip qtile alacritty perl-file-mimeinfo nautilus google-chrome visual-studio-code-bin
