...
echo '0' | sudo pacman -Sy --noconfirm numlockx xdg-user-dirs neofetch noto-fonts ttf-apple-emoji ttf-liberation unzip awesome qtile picom hsetroot gtk2 gtk3 hyper rofi rofimoji dunst xdg-utils perl-file-mimeinfo ranger nautilus file-roller pulseaudio playerctl unrar fzf catimg redshift ntfs-3g wget gnome-keyring uget zathura zathura-pdf-mupdf vlc python-pip tldr #alacritty
