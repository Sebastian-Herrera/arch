...
echo '0' | sudo pacman -Sy --noconfirm xdg-user-dirs neofetch noto-fonts-emoji unzip qtile hsetroot gtk2 gtk3 alacritty perl-file-mimeinfo ranger nautilus pulseaudio playerctl unrar fzf catimg
