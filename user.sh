...
echo '0' | sudo pacman -Sy --noconfirm xdg-user-dirs neofetch noto-fonts-emoji unzip qtile picom hsetroot gtk2 gtk3 alacritty rofi perl-file-mimeinfo ranger nautilus pulseaudio playerctl unrar fzf catimg redshift nodejs-lts-erbium npm ntfs-3g
