...
echo '0' | sudo pacman -Sy --noconfirm numlockx xdg-user-dirs neofetch noto-fonts ttf-apple-emoji unzip awesome qtile picom hsetroot gtk2 gtk3 alacritty rofi dunst xdg-utils perl-file-mimeinfo ranger nautilus pulseaudio playerctl unrar fzf catimg redshift ntfs-3g wget gnome-keyring uget zathura zathura-pdf-mupdf
...
yay -Sy --noconfirm nautilus-open-any-terminal escrotum-git bottom google-chrome visual-studio-code-bin notion-app uget-integrator-chrome #zsh-theme-powerlevel10k-git spotify spicetify-cli
#localectl set-locale LANG=en_US.UTF-8

#Starship
git clone https://github.com/zsh-users/zsh-autosuggestions ~/.zsh/zsh-autosuggestions
git clone https://github.com/zsh-users/zsh-syntax-highlighting ~/.zsh/zsh-syntax-highlighting
curl -O https://raw.githubusercontent.com/ohmyzsh/ohmyzsh/master/plugins/archlinux/archlinux.plugin.zsh && mkdir ~/.zsh/archlinux/ && mv archlinux.plugin.zsh ~/.zsh/archlinux/
...
curl -O https://raw.githubusercontent.com/ohmyzsh/ohmyzsh/master/plugins/git/git.plugin.zsh && mkdir ~/.zsh/git/ && mv git.plugin.zsh ~/.zsh/git/
