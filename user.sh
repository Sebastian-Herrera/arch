...
yay -Sy --noconfirm nautilus-open-any-terminal maim bottom glow google-chrome uget-integrator-chrome visual-studio-code-bin notion-app figma-linux spotify spicetify-cli #zsh-theme-powerlevel10k-git
